...
- (void)setVlcAudioData:(NSArray *)vlcAudioData {
    ...
    [vlcAudioData enumerateObjectsUsingBlock:^(id  _Nonnull obj, NSUInteger idx, BOOL * _Nonnull stop) {
