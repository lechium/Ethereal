...
#rm layout/Applications/nitoTV.app/About.txt
sed -e "s/^Version: \(.*\)/Version: \1$buildno_part$extra_part/g" $CONTROL
#sed -e "s/nitoTV \(.*\) for AppleTV 4/nitoTV \1$buildno_part$extra_part for AppleTV 4/g" nitoTV4/About.txt >> layout/Applications/nitoTV.app/About.txt
